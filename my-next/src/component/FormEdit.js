...
import {addReviews, removeReviews} from "@/lib/actions";
    ...
    return (
        <form action={addReviews}>
            ...
            <div className="mb-3">
                ...
                <input type="date" id="read" name="read" className="block bg-gray-100 border-2 border-gray-600 rounded forcus:bg-white focus:outline-none focus:border-red-500" defaultValue={read} />
            </div>
            <div className="mb-3">
            ...
            <button type="submit" className="bg-red-600 text-white rounded px-4 py-2 hover:bg-red-500" formAction={removeReviews}>削除</button>
        </form>
    );
}