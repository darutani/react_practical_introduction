import {createBrowserRouter, createRoutesFromElements, json, redirect, Route} from "react-router-dom";
...
import yup from "../chapter4/yup.jp";
...
const bookAction = async ({ request }) => {
    ...
    const bookSchema = yup.object({
        title: string().label('署名').required().max(100),
